...
{
	DE_Matrix3x3 newMat;
	newMat.f00 = f00; newMat.f01 = f01; newMat.f02 = f02;
	newMat.f10 = f10; newMat.f11 = f11;	newMat.f12 = f12;
	newMat.f20 = f20; newMat.f21 = f21;	newMat.f22 = f22;
...
{
	DE_Matrix3x3 newMat;
	newMat.f00 = 1; newMat.f01 = 0; newMat.f02 = 0;
	newMat.f10 = 0; newMat.f11 = 1; newMat.f12 = 0;
	newMat.f20 = 0; newMat.f21 = 0; newMat.f22 = 1;
